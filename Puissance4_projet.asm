...
ErrorSup7:
	...
	beq $a0 1 playerOne
	j  playerTwo			# il faut mettre les jr pour toutes les error differente sinon il affiche toutes les 3
#colonne choisit <1 
ErrorInf1:
	move $t1 $a0			#sauvegarde dans $a0 dans $t1 pour ne pas perdre le nuùmero joueur dans $a0
...
vertical_boucle:
	...
	addi $t0 $t0 -28		# On va a la ligne suivante
	lw $t3 ($t0)			#$t3 = Grille[$t0]
...
diagonale1_up:
	...
	addi $t0 $t0 32			# On va a la ligne suivante
	lw $t3 ($t0)			#$t3 = Grille[$t0]
...
diagonale1_down:
	...
	addi $t0 $t0 -32		# On deplace à la linge plus bas
	lw $t3 ($t0)			#$t3 = Grille[$t0]
...
diagonale2_up:
	...
	addi $t0 $t0 24			# On va a la ligne suivante
	lw $t3 ($t0)			# $t3 = Grille[$t0]
...
diagonale2_down:
	...
	addi $t0 $t0 -24		# On va à la linge suivante
	lw $t3 ($t0)			# $t3 = Grille[$t0]
